...
public enum FileCategory {
    ...
    */
    ...
    공과대학_시행세칙_세부지침서("선거관리위원회","공과대학","시행세칙·세부지침서"),
    ...
    자유전공학부_시행세칙_세부지침서("선거관리위원회","자유전공학부","시행세칙·세부지침서"),
    ...
    공과대학_특별선거시행세칙("선거관리위원회","공과대학","특별선거시행세칙"),
    ...
    자유전공학부_특별선거시행세칙("선거관리위원회","자유전공학부","특별선거시행세칙"),
    ...
    자유전공학부_선관위_기타("선거관리위원회","자유전공학부","기타"),
    ...
    // 예결산안
    경영대학_예결산안("경영대학", "경영대학", "예·결산안"),
    경영학부_예결산안("경영대학", "경영학부", "예·결산안"),
    벤처중소기업학과_예결산안("경영대학", "벤처중소기업학과", "예·결산안"),
    회계학과_예결산안("경영대학", "회계학과", "예·결산안"),
    금융학부_예결산안("경영대학", "금융학부", "예·결산안"),
    ...
    // 경제통상대학 - 예결산안
    경제통상대학_예결산안("경제통상대학", "경제통상대학", "예·결산안"),
    경제학과_예결산안("경제통상대학", "경제학과", "예·결산안"),
    글로벌통상학과_예결산안("경제통상대학", "글로벌통상학과", "예·결산안"),
    금융경제학과_예결산안("경제통상대학", "금융경제학과", "예·결산안"),
    국제무역학과_예결산안("경제통상대학", "국제무역학과", "예·결산안"),
    ...
    // 예결산안
    공과대학_예결산안("공과대학", "공과대학", "예·결산안"),
    화학공학과_예결산안("공과대학", "화학공학과", "예·결산안"),
    신소재공학과_예결산안("공과대학", "신소재공학과", "예·결산안"),
    전기공학부_예결산안("공과대학", "전기공학부", "예·결산안"),
    기계공학부_예결산안("공과대학", "기계공학부", "예·결산안"),
    산업정보시스템공학과_예결산안("공과대학", "산업정보시스템공학과", "예·결산안"),
    건축학부_예결산안("공과대학", "건축학부", "예·결산안"),
    ...
    // 예결산안
    법과대학_예결산안("법과대학", "법과대학", "예·결산안"),
    법학과_예결산안("법과대학", "법학과", "예·결산안"),
    국제법무학과_예결산안("법과대학", "국제법무학과", "예·결산안"),
    ...
    // 법과대학자치단체운영위원회
    법과대학_법과대학자치단체운영위원회("법과대학", "법과대학", "법과대학자치단체운영위원회"),
    ...
    // 예결산안
    사회과학대학_예결산안("사회과학대학", "사회과학대학", "예·결산안"),
    사회복지학부_예결산안("사회과학대학", "사회복지학부", "예·결산안"),
    행정학부_예결산안("사회과학대학", "행정학부", "예·결산안"),
    정치외교학과_예결산안("사회과학대학", "정치외교학과", "예·결산안"),
    정보사회학과_예결산안("사회과학대학", "정보사회학과", "예·결산안"),
    언론홍보학과_예결산안("사회과학대학", "언론홍보학과", "예·결산안"),
    평생교육학과_예결산안("사회과학대학", "평생교육학과", "예·결산안"),
    ...
    // 예결산안
    인문대학_예결산안("인문대학", "인문대학", "예·결산안"),
    기독교학과_예결산안("인문대학", "기독교학과", "예·결산안"),
    국어국문학과_예결산안("인문대학", "국어국문학과", "예·결산안"),
    영어영문학과_예결산안("인문대학", "영어영문학과", "예·결산안"),
    독어독문학과_예결산안("인문대학", "독어독문학과", "예·결산안"),
    불어불문학과_예결산안("인문대학", "불어불문학과", "예·결산안"),
    중어중문학과_예결산안("인문대학", "중어중문학과", "예·결산안"),
    일어일문학과_예결산안("인문대학", "일어일문학과", "예·결산안"),
    철학과_예결산안("인문대학", "철학과", "예·결산안"),
    사학과_예결산안("인문대학", "사학과", "예·결산안"),
    문예창작전공_예결산안("인문대학", "문예창작전공", "예·결산안"),
    영화예술전공_예결산안("인문대학", "영화예술전공", "예·결산안"),
    스포츠학부_예결산안("인문대학", "스포츠학부", "예·결산안"),
    ...
    // 예결산안
    자연과학대학_예결산안("자연과학대학", "자연과학대학", "예·결산안"),
    수학과_예결산안("자연과학대학", "수학과", "예·결산안"),
    물리학과_예결산안("자연과학대학", "물리학과", "예·결산안"),
    화학과_예결산안("자연과학대학", "화학과", "예·결산안"),
    정보통계보험수리학과_예결산안("자연과학대학", "정보통계보험수리학과", "예·결산안"),
    의생명시스템학부_예결산안("자연과학대학", "의생명시스템학부", "예·결산안"),
    ...
    정보보호학과_회칙_세칙("IT대학", "정보보호학과", "회칙·세칙"),
    ...
    정보보호학과_회의록("IT대학", "정보보호학과", "회의록"),

    // 예결산안
    IT대학_예결산안("IT대학", "IT대학", "예·결산안"),
    컴퓨터학부_예결산안("IT대학", "컴퓨터학부", "예·결산안"),
    전자정보공학부_예결산안("IT대학", "전자정보공학부", "예·결산안"),
    글로벌미디어학부_예결산안("IT대학", "글로벌미디어학부", "예·결산안"),
    소프트웨어학부_예결산안("IT대학", "소프트웨어학부", "예·결산안"),
    AI융합학부_예결산안("IT대학", "AI융합학부", "예·결산안"),
    미디어경영학과_예결산안("IT대학", "미디어경영학과", "예·결산안"),
    정보보호학과_예결산안("IT대학", "정보보호학과", "예·결산안"),
    ...
    // 회칙 세칙
    자유전공학부_회칙_세칙("자유전공학부", "자유전공학부", "회칙·세칙"),

    // 회의록
    자유전공학부_회의록("자유전공학부", "자유전공학부", "회의록"),

    // 예결산안
    자유전공학부_예결산안("자유전공학부", "자유전공학부", "예·결산안"),

    // 활동보고
    자유전공학부_활동보고("자유전공학부", "자유전공학부", "활동보고"),

    // 기타
    자유전공학부_기타("자유전공학부", "자유전공학부", "기타"),
    ...
    // 예결산안
    동아리연합회_예결산안("동아리연합회", "동아리연합회", "예·결산안"),
    ...
    // 예결산안
    차세대반도체학과_예결산안("차세대반도체학과", "차세대반도체학과", "예·결산안"),
