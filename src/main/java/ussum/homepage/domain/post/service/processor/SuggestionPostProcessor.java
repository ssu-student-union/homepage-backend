...
@Service
public class SuggestionPostProcessor extends BasePostProcessor {

    public SuggestionPostProcessor(PostRepository postRepository, PostCommentReader postCommentReader,
