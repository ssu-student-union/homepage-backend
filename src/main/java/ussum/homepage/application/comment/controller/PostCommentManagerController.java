...
public class PostCommentManagerController {
    ...
    @Operation(summary = "게시물 단건 조회 시 댓글과 대댓글을 모두 조회하는 api", description = """
            ...
            요청으로 postId, type(인기순 or 최신순), 그리고 form-data 형식으로 key : userId , value: Long 형의 실제 userId 값을 넣으면 됩니다.
            ...
            userId를 넣고 반환되는 isAuthor 필드가 true 라면 해당 user는 본인이 작성한 댓글, 대댓글 임을 나타냅니다.
